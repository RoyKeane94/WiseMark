export const HIGHLIGHT_COLORS = {
  yellow: { key: 'yellow', label: 'Yellow', name: 'Business & Management', hex: '#EAB308', rgba: 'rgba(254, 243, 199, 0.5)', rgbaSoft: 'rgba(234,179,8,0.18)', rgbaHover: 'rgba(234,179,8,0.38)', solid: '#fbbf24' },
  green:  { key: 'green',  label: 'Green',  name: 'Financials', hex: '#22C55E', rgba: 'rgba(209, 250, 229, 0.5)', rgbaSoft: 'rgba(34,197,94,0.18)', rgbaHover: 'rgba(34,197,94,0.38)', solid: '#10b981' },
  blue:   { key: 'blue',   label: 'Blue',   name: 'Market', hex: '#3B82F6', rgba: 'rgba(219, 234, 254, 0.5)', rgbaSoft: 'rgba(59,130,246,0.18)', rgbaHover: 'rgba(59,130,246,0.38)', solid: '#3b82f6' },
  ...
  orange: { key: 'orange', label: 'Orange', name: 'Investment Highlights', hex: '#F97316', rgba: 'rgba(254, 215, 170, 0.5)', rgbaSoft: 'rgba(249,115,22,0.18)', rgbaHover: 'rgba(249,115,22,0.38)', solid: '#f59e0b' },
};
